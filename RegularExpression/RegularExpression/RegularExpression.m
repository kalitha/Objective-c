...
-(void)regularExpression:(NSString *)str{
    ...
    NSRegularExpression *regex =[NSRegularExpression regularExpressionWithPattern:@"[<]{2}[a-z]{4}[>]{2}" options:NSRegularExpressionCaseInsensitive error:nil];
  ...
  NSString *string=[regex stringByReplacingMatchesInString:str options:0 range:NSMakeRange(0, [str length]) withTemplate:frstNme];
    ...
    NSRegularExpression *regex1=[NSRegularExpression regularExpressionWithPattern:@"[<]{2}[a-z]{4}[ ][a-z]{4}[>]{2}" options:NSRegularExpressionCaseInsensitive error:nil];
    ...
    NSRegularExpression *regex2 =[NSRegularExpression regularExpressionWithPattern:@"[x]{10}" options:NSRegularExpressionCaseInsensitive error:nil];
   ...
   NSString *date=[dateFormat stringFromDate:[NSDate date]];
    ...
    NSRegularExpression *regex3=[NSRegularExpression regularExpressionWithPattern:@"[a-z]{2}[/][a-z]{2}[/][a-z]{4}" options:NSRegularExpressionCaseInsensitive error:nil];
